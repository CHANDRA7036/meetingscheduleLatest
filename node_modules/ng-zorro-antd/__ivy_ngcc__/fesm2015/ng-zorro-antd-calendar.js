...
function NzCalendarHeaderComponent_nz_option_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const year_r513 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("nzLabel", year_r513.label)("nzValue", year_r513.value);
} }
function NzCalendarHeaderComponent_nz_select_3_nz_option_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "nz-option", 7);
} if (rf & 2) {
    const month_r515 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("nzLabel", month_r515.label)("nzValue", month_r515.value);
} }
function NzCalendarHeaderComponent_nz_select_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ngModelChange", function NzCalendarHeaderComponent_nz_select_3_Template_nz_select_ngModelChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r517); const ctx_r516 = ɵngcc0.ɵɵnextContext(); return ctx_r516.monthChange.emit($event); });
    ...
    ɵngcc0.ɵɵproperty("nzSize", ctx_r512.size)("nzDropdownMatchSelectWidth", false)("ngModel", ctx_r512.activeMonth);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r512.months);
} }
...
function NzCalendarComponent_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("valueChange", function NzCalendarComponent_ng_template_5_Template_date_table_valueChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r524); const ctx_r523 = ɵngcc0.ɵɵnextContext(); return ctx_r523.onDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r520 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("prefixCls", ctx_r520.prefixCls)("value", ctx_r520.activeDate)("activeDate", ctx_r520.activeDate)("cellRender", ctx_r520.dateCell)("fullCellRender", ctx_r520.dateFullCell);
} }
function NzCalendarComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("valueChange", function NzCalendarComponent_ng_template_7_Template_month_table_valueChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r526); const ctx_r525 = ɵngcc0.ɵɵnextContext(); return ctx_r525.onDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r522 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("prefixCls", ctx_r522.prefixCls)("value", ctx_r522.activeDate)("activeDate", ctx_r522.activeDate)("cellRender", ctx_r522.monthCell)("fullCellRender", ctx_r522.monthFullCell);
} }
...
NzCalendarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzCalendarComponent, selectors: [["nz-calendar"]], contentQueries: function NzCalendarComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        const _r519 = ɵngcc0.ɵɵreference(6);
        const _r521 = ɵngcc0.ɵɵreference(8);
        ...
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngIf", ctx.nzMode === "month")("ngIfThen", _r519)("ngIfElse", _r521);
